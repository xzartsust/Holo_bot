...
class HelpCommands(commands.Cog):
    ...
    async def vote_subcommands(self, ctx):
        ...
        vote_emb=discord.Embed(
            ...
            colour = discord.Color.teal(), 
            description = f'**Команда**: `[vote]`\n**Описание**: создает голосование на сервере\n**Использования**: `{prefix}vote *\"тема голосования\"* [cылка на картинку] *текст*`\n\n**Пример:** `{prefix}vote \"Голосования!\" https://raw.githubusercontent.com/xzartsust/Tobi-Bot/master/files/image/c8c4113dda8117f63cc993c981f2732d.png О чем голосуем?`\nМожно использовать без картинки\n\n**Внимание!**\nТема голосование должно быть обязательно в двойных кавычках, также у юзера который использует эту команду, в его роли должна быть включена функция управления сообщениями (manage messages)'
        )
        vote_emb.set_footer(
            text = ctx.message.author,
            icon_url = ctx.message.author.avatar_url
